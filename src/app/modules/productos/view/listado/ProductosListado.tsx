...
const tableColumns: MRT_ColumnDef<ProductoProps>[] = [
  ...
  },
  {
    ...
    id: 'precio',
    size: 135,
    accessorFn: (row) => genReplaceEmpty(row.precio, ''),
  },
  {
  ...
  },
  {
    ...
    size: 135,
    accessorFn: (row) => genReplaceEmpty(row.subPartidaArancelaria, ''),
  },
  {
    accessorKey: 'alicuotaDescripcion',
    header: 'Alicuota',
    id: 'alicuotaDescripcion',
    size: 135,
    accessorFn: (row) => genReplaceEmpty(row.alicuotaDescripcion, ''),
  },
  {
    ...
    size: 135,
    accessorFn: (row) => genReplaceEmpty(row.alicuotaEspecifica, ''),
  },
  {
    ...
    size: 135,
    accessorFn: (row) => genReplaceEmpty(row.alicuotaPorcentual, ''),
  },
  {
