...
const ProductoHomologacion: FunctionComponent<Props> = (props) => {
  ...
  const { data: productosServicios, error: prodServError } = useQuery<
    ...
    Error
  >({
    queryKey: ['productosServicios', codigoActividadWatch],
    queryFn: async () => {
                ...
                render={({ field }) => (
                  <FormControl fullWidth error={Boolean(errors.codigoActividad)}>
                    ...
                    <Select<SinActividadesDocumentoSectorProps>
                      {...field}
                      styles={reactSelectStyle(Boolean(errors.codigoActividad))}
                      name="codigoActividad"
                ...
                render={({ field }) => (
                  ...
                  >
                    ...
                    <Select<SinProductoServicioProps>
                      {...field}
                      styles={reactSelectStyle(Boolean(errors.codigoProductoSin))}
                      menuPosition={'fixed'}
                      name="codigoProductoSin"
                      placeholder={'Seleccione Servicio para homologación'}
              ...
              <Controller
                ...
                render={({ field }) => (
                  <FormControl fullWidth error={Boolean(errors.subPartidaArancelaria)}>
                    ...
                    <Select
                      styles={reactSelectStyle(Boolean(errors.subPartidaArancelaria))}
                      menuPosition={'fixed'}
                      name="subPartidaArancelaria"
                      placeholder={
                        field.value
