...
//     },
//     setItemModificado: (state, action: PayloadAction<FacturaAlquilerDetalleInput>) => {
...
//     },
//     setDeleteItem: (state, action: PayloadAction<FacturaAlquilerDetalleInput>) => {
